...
#ANALYSISDIR=/home/yiktungho/RivetAnalysis
RIVETDIR=/home/yiktungho/RivetAnalysis
OUTPUTDIR=/home/yiktungho/RivetAnalysis/AnaResults/$PROCESS
ls $OUTPUTDIR
if [ $? -ne 0 ]
then
	mkdir $OUTPUTDIR
...
do
	...
	echo source /home/yiktungho/rivet_sandbox/local/rivetenv.sh >> $PROCESS$COUNTER.sh
	echo source /home/yiktungho/rivet_sandbox/local/yodaenv.sh >> $PROCESS$COUNTER.sh
	...
	#do
		RIVETCMD="$RIVETCMD ${ARRAY[$COUNTER]}"
	#done
