...
int main( int argc, char** argv )
{
   ...
   TString outfileName( "TMVA_TopVeto.root" );
   ...
   (TMVA::gConfig().GetIONames()).fWeightFileDir = "TopVetoWeights";
...
/*
   ...
   Double_t ttbarWeight = 1.;//27.38889204589483; 
   ...
   //TCut mycuts = "";
   //TCut mycutb = "";
   TCut mycuts = "abs(m12 - 115.) < 25. && abs(m34 - 110.) < 25."; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "abs(m12 - 115.) < 25. && abs(m34 - 110.) < 25."; // for example: TCut mycutb = "abs(var1)<0.5";
